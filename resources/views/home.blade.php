@extends('layouts.front.masterview')
@section('content')
<div id="mainCarousel">
        ...
        <div class="item active">
          <script
			...
			marker=new google.maps.Marker({
			  position:myCenter,
			 // icon:'assets/images/nepali-momo.png',
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="front/assets/images/nepali-momo.png" alt="Generic placeholder image">
          <h2>Nepalese MOMO</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="front/assets/images/burger.png" alt="Generic placeholder image">
          <h2>Burger</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. </p>
          <p><a class="btn btn-default" href="#" role="button">&pound;5 Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
		  <img class="img-circle" src="front/assets/images/gorkha-special-chicken.png" alt="Lam Tikka">
	...
	<div id="myCarousel1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
         <div class="row">
        <div class="col-lg-4">
          <img src="front/assets/images/salate.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="front/assets/images/burger.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="front/assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="col-lg-4">
          <img  src="assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
	...
	<div id="myCarousel2" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
         <img src="front/assets/images/chicken.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="assets/images/drinks_lussy.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="front/assets/images/chicken_fry.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="front/assets/images/fish-and-chips.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div id="myCarousel3" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
          <img src="front/assets/images/rice.png" alt="Generic placeholder image">
          <h4>Rice</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="front/assets/images/courinder.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div class="row">
		<div class="col-lg-4">
		<div class="media">
			<a href="menu/"><img src="front/assets/images/nepali-momo.png" alt="nepali-momo"> </a>
		...
		<div class="col-lg-4">
		<div class="media"><a href="menu/"><img src="front/assets/images/gorkha-special-chicken.png" alt="GURKHA SPECIAL CHICKEN"> </a>						
		...
		<div class="col-lg-4">
		<div class="media">
		<a href="menu/"><img src="front/assets/images/lam-tikka.png" alt="Lam Tikka"> </a>
   ...
   <div id="myCarousel4" class="carousel slide" data-ride="carousel">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img src="front/assets/images/fish-and-chips.png" alt="Fish and Chips">
        </div>
      </div>
      </div>
	...
	<div class="item">
      <div class="row featurette">
        ...
        <div class="col-md-5">
		  <img class="img-circle" src="front/assets/images/drinks.png" alt="Generic placeholder image">
        </div>
      </div>
      </div>
	   </div>
